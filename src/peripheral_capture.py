...
# user can place custom header file here
header_file = r'C:\Users\Public\Documents\py_3\Gui_Auto\src\MoD_DB_header.py'
...
class MainApplication(tk.Frame):
    ...
    def main_gui(self):
        ...
        tk.Label(root, text=f"\nTo capture an Image: begin image capture mode\n"
                            "    Press Shift to Select Top Left Corner of Image\n"
                            "    Press Ctrl to Select Bottom Right Corner of Image and Save\n"
                            "the bigger the image, the easier to locate\n"
    ...
    def call_program(self):
        ...
        write_output_file(recorded_data=self.recorded_data, save_file_path=self.file_path, header_file_path=header_file)
    ...
    def start_listener(self) -> None:
        ...
        def on_press(key):
            ...
            if key in (Key.ctrl_l, Key.ctrl_r) and mouse_top_left_corner and img_capturing:
